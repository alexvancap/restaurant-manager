...
bob = Employee.create({name: "Bob", email: "bob@alex.com", phone: "123456789", mainRole: "manager"})
bobby = Employee.create({name: "Bobby", email: "bobby@alex.com", phone: "123456789", mainRole: "manager"})


wt1 = Worktime.create({startTime: "2020-1-21 09:12:00", endTime: "2020-1-21 20:1:21", employee: bob, restaurant: ihop, role: "manager"})
